    ...
    <motion.div
        ...
        >
          <h1 className="hero-title">
            Chào mừng đến với Hiến Máu Cộng Đồng Việt
          </h1>
          <p className="hero-subtitle">
            Cùng nhau lan tỏa yêu thương, sẻ chia sự sống.
          </p>
          <p className="hero-description">
            Website Hiến Máu Cộng Đồng Việt là nền tảng kết nối giữa những tấm lòng nhân ái với các trung tâm y tế trên toàn quốc. 
