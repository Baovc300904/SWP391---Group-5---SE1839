          ...
          <div style={{ padding: '40px' }}>
            ...
            <Space direction="vertical" size="large" style={{ width: '100%' }}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div>
                  <Title level={5} style={{ margin: 0, color: '#2c3e50' }}>Đặt lịch hiến máu</Title>
                  <Paragraph style={{ margin: 0, color: '#7f8c8d' }}>Đặt lịch hẹn hiến máu trực tuyến tiện lợi</Paragraph>
                </div>
              </div>
