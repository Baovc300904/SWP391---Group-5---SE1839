  ...
  const benefits = [
    {
      ...
      description: "Quy trình bao gồm các bước xét nghiệm trước khi hiến và nhận máu đảm bảo an toàn cho người dùng",
      color: "#f87171"
    },
    {
      icon: <SmileOutlined />,
      ...
      <div className="benefits-container">
        <div className="benefits-header">
          <Title level={2} className="benefits-title">
            Tại sao chọn <span>Hiến Máu Cộng Đồng Việt?</span>
          </Title>
